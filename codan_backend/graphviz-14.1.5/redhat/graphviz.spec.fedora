...
Source0: https://gitlab.com/graphviz/graphviz/-/archive/14.1.5/graphviz-14.1.5.tar.gz
...
BuildRequires: libX11-devel freeglut-devel
...
%endif
%if %{GTK}
BuildRequires: gtk2-devel libglade2-devel gtkglext-devel
%endif
%if %{GTS}
...
%if 0%{?fedora} > 0 || 0%{?rhel} == 8 || 0%{?rhel} == 9
%package lang-guile
Group:          Applications/Multimedia
